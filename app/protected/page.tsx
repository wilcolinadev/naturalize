    ...
    <div className="flex-1 w-full flex flex-col gap-12 max-w-5xl mx-auto p-5">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="group p-8 border-2 rounded-2xl bg-gradient-to-br from-blue-50/50 to-card dark:from-blue-950/10 dark:to-card hover:shadow-xl hover:scale-105 transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-700 opacity-75">
